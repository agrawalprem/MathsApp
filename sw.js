...
// Version 1.0.25-RESTORED - Force cache refresh after restore to working state

const CACHE_NAME = 'maths-app-v1.0.25-RESTORED';
const STATIC_CACHE_NAME = 'maths-app-static-v1.0.25-RESTORED';
